...
export function IncidentDetail({ alert, onClose }: IncidentDetailProps) {
  ...
  return (
    <div className={cn(
      "h-full bg-[#06070a] border border-white/10 rounded-sm flex flex-col relative overflow-hidden group select-none shadow-[0_0_40px_rgba(0,0,0,0.5)]",
      isSQLi ? "shadow-[inset_0_0_20px_rgba(239,68,68,0.05)]" : ""
    )}>
      {/* HEADER SECTION */}
      <div className="p-5 pb-2">
        <div className="flex items-center justify-between mb-2">
          ...
          {onClose && (
            <button 
              onClick={onClose}
              className="w-5 h-5 rounded-full border border-gray-700 flex items-center justify-center hover:bg-white/10 transition-all text-white group"
            >
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-mono font-black text-gray-300">INC-2025-05-19-1024-001</span>
          </div>
      ...
      {/* TABS SECTION */}
      <div className="flex border-b border-white/5 text-[8px] font-black uppercase tracking-[0.2em]">
        <div className="px-5 py-2.5 text-gray-600 hover:text-gray-300 cursor-pointer transition-colors border-b-2 border-transparent">Overview</div>
        <div className={cn(
          "px-5 py-2.5 cursor-pointer transition-all border-b-2",
          isSQLi ? "border-blue-500 text-blue-400" : "border-gray-300 text-white"
        )}>Payload & Context</div>
        <div className="px-5 py-2.5 text-gray-600 hover:text-gray-300 cursor-pointer transition-colors border-b-2 border-transparent">AI Analysis</div>
        <div className="px-5 py-2.5 text-gray-600 hover:text-gray-300 cursor-pointer transition-colors border-b-2 border-transparent">MITRE ATT&CK</div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1 cursor-pointer group/copy">
                <Copy className="w-2.5 h-2.5 text-gray-700 group-hover/copy:text-gray-400" />
                <span className="text-[8px] text-gray-600 font-black group-hover/copy:text-gray-400">COPY</span>
              </div>
            </div>
          </div>
          <div className="bg-[#030408] border border-white/5 rounded-sm p-3 font-mono text-[9px] leading-relaxed relative">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 bg-white/3 p-2 rounded-sm border border-white/5">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-y-4">
            ...
            <div>
              ...
              <span className="text-[10px] font-black text-gray-300 font-mono tracking-tight">54321</span>
            </div>
            <div>
              <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest block mb-1">Destination IP</span>
              <span className="text-[10px] font-black text-gray-300 font-mono tracking-tight pointer-events-none">10.0.12.15</span>
            </div>
            <div>
              <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest block mb-1">Destination Port</span>
              <span className="text-[10px] font-black text-gray-300 font-mono tracking-tight">443</span>
            </div>
            <div>
              <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest block mb-1">Protocol</span>
              <span className="text-[10px] font-black text-gray-300 tracking-tight uppercase">TCP</span>
            </div>
            <div>
              <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest block mb-1">Direction</span>
              <span className="text-[10px] font-black text-gray-300 tracking-tight uppercase">External → Internal</span>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-end">
                ...
                <span className="text-[10px] font-mono font-black text-gray-200">0.96</span>
              </div>
              <div className="h-1 w-full bg-white/5 rounded-full overflow-hidden">
            ...
            <div className="flex justify-between border-b border-white/[0.02] pb-1">
              ...
              <span className="text-[9px] font-mono font-black text-gray-400">10:24:17 AM</span>
            </div>
            <div className="flex justify-between border-b border-white/[0.02] pb-1">
              <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest">Last Seen</span>
              <span className="text-[9px] font-mono font-black text-gray-400">10:24:19 AM</span>
            </div>
            <div className="flex justify-between border-b border-white/[0.02] pb-1">
              <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest">Occurrences</span>
              <span className="text-[9px] font-mono font-black text-gray-400">3</span>
            </div>
            <div className="flex justify-between border-b border-white/[0.02] pb-1">
      ...
      {/* FOOTER ACTIONS */}
      <div className="p-4 bg-[#030408] border-t border-white/5 flex gap-2">
        <button className="flex-1 py-3 px-1 border border-white/10 text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 hover:text-white hover:bg-white/5 transition-all rounded-sm">
          ISOLATE SOURCE
        </button>
        <button className="flex-1 py-3 px-1 border border-white/10 text-[8px] font-black uppercase tracking-[0.2em] text-gray-400 hover:text-white hover:bg-white/5 transition-all rounded-sm">
          BLOCK IP
