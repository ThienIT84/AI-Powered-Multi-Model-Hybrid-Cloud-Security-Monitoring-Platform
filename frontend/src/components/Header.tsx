      ...
      <div className="flex items-center">
        ...
        <div className="flex items-center">
          ...
          <div className="flex flex-col px-6 border-r hidden lg:flex border-border">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.1em] font-mono leading-none text-foreground">{formatTime(time)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex justify-end items-center gap-4 lg:gap-8 px-4 lg:px-8">
        ...
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          <Settings 
            className={cn(
              "w-4 h-4 cursor-pointer transition-colors", 
              isSettingsOpen ? "text-cyan-500" : "text-muted-foreground hover:text-foreground"
            )} 
