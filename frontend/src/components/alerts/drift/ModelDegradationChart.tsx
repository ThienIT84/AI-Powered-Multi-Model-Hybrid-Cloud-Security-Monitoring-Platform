...
export function ModelDegradationChart() {
  ...
  return (
    <div className="space-y-4">
      {/* Target Title & Stats */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 select-none leading-none">
        <div>
      ...
      <div className="bg-background/40 border border-border/70 rounded-xl p-3.5 space-y-3.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1 border-t border-border/40 select-none leading-none">
          <div className="bg-red-500/1 border border-red-500/10 p-2.5 rounded-lg flex items-start gap-2">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[7.5px] text-muted-foreground leading-normal font-medium">
          ...
          <div className="bg-cyan-500/1 border border-cyan-500/10 p-2.5 rounded-lg flex items-start gap-2">
...
export default ModelDegradationChart;
