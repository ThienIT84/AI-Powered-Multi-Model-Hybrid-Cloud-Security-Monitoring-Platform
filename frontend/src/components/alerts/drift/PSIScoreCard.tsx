            ...
            >
              <div>
                ...
                <div className="flex items-baseline gap-1 mt-3">
                  ...
                  <span className="text-[7.5px] text-muted-foreground uppercase tracking-wider font-extrabold font-mono animate-pulse">
                    PSI Index
                  </span>
                </div>
              </div>
              ...
              <div className="mt-3.5 pt-2 border-t border-border/40 flex items-start gap-1.5">
                ...
                <p className="text-[7.5px] text-muted-foreground leading-tight font-medium">{meta.message}</p>
              </div>
            </div>
          );
        })}
