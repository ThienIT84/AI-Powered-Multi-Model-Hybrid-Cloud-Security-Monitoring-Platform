...
import { CORRELATION_TIMELINE } from "./correlationConfig";
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1 mt-0.5 leading-none max-w-27.5">
                  <span className="text-[8px] font-black text-foreground uppercase tracking-wide block truncate">{step.title}</span>
                  <span className="text-[6.5px] text-[#06b6d4] uppercase tracking-wider font-extrabold font-mono">
                     {step.engine}
                  </span>
                </div>
              </div>
        ...
        {(() => {
          ...
          return (
            <motion.div
              ...
              className="p-3 bg-secondary/15 border border-border rounded-xl flex items-start gap-2.5 leading-normal shadow-inner"
            >
              <div className={cn(
