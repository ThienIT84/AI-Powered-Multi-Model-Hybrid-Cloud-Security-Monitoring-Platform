    ...
    <div className="space-y-4">
      ...
      <div className="bg-background/40 border border-border/70 rounded-xl overflow-hidden">
        ...
        <table className="w-full text-left text-[8.5px] border-collapse">
          <thead>
            <tr className="bg-muted/30 border-b border-border font-bold text-muted-foreground h-7">
        ...
        <div className="p-3 border-t border-border bg-muted/10 grid grid-cols-2 md:grid-cols-3 gap-3">
          <div className="space-y-1">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[7px] text-muted-foreground uppercase font-semibold">latency</span>
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[8px] text-muted-foreground uppercase tracking-wider font-mono font-extrabold">({agreementRateText})</span>
            </div>
          </div>
