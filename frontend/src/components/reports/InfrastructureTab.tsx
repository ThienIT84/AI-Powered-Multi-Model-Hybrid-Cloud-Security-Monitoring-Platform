    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-card border border-border rounded-xl p-4 flex items-center justify-between gap-4 shadow-sm group relative overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-purple-500/10 text-purple-655 dark:text-purple-400 rounded-lg border border-purple-500/25 group-hover:bg-purple-500/20 transition duration-300">
            ...
            <div>
              ...
              <span className="text-lg font-black font-mono text-foreground leading-none">
                {sums.avgKafka.toLocaleString()} <span className="text-xs text-muted-foreground font-sans">eps</span>
              </span>
            </div>
          </div>
          <div className="text-right">
            <span className="text-[8px] font-mono text-muted-foreground uppercase">Broker cluster</span>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-4 flex items-center justify-between gap-4 shadow-sm group relative overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-cyan-500/10 text-cyan-655 dark:text-cyan-400 rounded-lg border border-cyan-500/25 group-hover:bg-cyan-500/20 transition duration-300">
            ...
            <div>
              ...
              <span className="text-lg font-black font-mono text-foreground leading-none">
                {Math.ceil(sums.avgKafka * 0.95).toLocaleString()} <span className="text-xs text-muted-foreground font-sans">eps</span>
              </span>
            </div>
          </div>
          <div className="text-right">
            <span className="text-[8px] font-mono text-muted-foreground uppercase">Elasticsearch</span>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-4 flex items-center justify-between gap-4 shadow-sm group relative overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-lg border border-emerald-500/25 group-hover:bg-emerald-500/20 transition duration-300">
            ...
            <div>
              ...
              <span className="text-lg font-black font-mono text-emerald-600 dark:text-emerald-400 leading-none">
                {sums.avgLatency} <span className="text-xs text-muted-foreground font-sans">ms</span>
              </span>
            </div>
          </div>
          <div className="text-right">
            <span className="text-[8px] font-mono text-muted-foreground uppercase flex items-center gap-1 justify-end">
        ...
        <div className="bg-card border border-border rounded-xl p-4 flex items-center justify-between gap-4 shadow-sm group relative overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-red-500/10 text-red-555 dark:text-red-400 rounded-lg border border-red-500/25 group-hover:bg-red-500/20 transition duration-300">
            ...
            <div>
              ...
              <span className={`text-lg font-black font-mono leading-none ${sums.droppedTotal > 0 ? 'text-red-555 dark:text-red-400' : 'text-muted-foreground'}`}>
                {sums.droppedTotal} <span className="text-xs text-muted-foreground font-sans">eps</span>
              </span>
            </div>
          </div>
          <div className="text-right">
            <span className={`text-[8.5px] font-mono font-bold uppercase truncate block px-1 rounded ${
              sums.droppedTotal > 10 ? 'bg-red-500/10 text-red-555 dark:text-red-400 border border-red-500/20' : 'bg-transparent text-muted-foreground'
            }`}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-border rounded-xl p-5 flex flex-col justify-between shadow-md h-86.25px">
            <div className="space-y-4 flex-1 overflow-auto custom-scrollbar pr-1">
              <div className="space-y-1 text-left">
                <span className="text-[8px] font-mono font-black text-muted-foreground uppercase tracking-widest">INGEST PIPELINE TYPE</span>
                <p className="text-xs font-bold text-foreground uppercase font-mono">Suricata IP / Zeek connection stream</p>
              </div>
              ...
              <div className="space-y-3.5 border-t border-border pt-4">
                <div className="space-y-1">
                  <div className="flex justify-between items-center text-[9px] font-mono font-bold uppercase">
                    <span className="text-muted-foreground">AWS INCOMING QUEUE SATURATION</span>
                    <span className="text-foreground">{(sums.maxQueue > 1000 ? `${(sums.maxQueue/1000).toFixed(1)}k` : sums.maxQueue)} msg</span>
                  </div>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between items-center text-[9px] font-mono font-bold uppercase">
                    <span className="text-muted-foreground">INGEST ENGINE CAPACITY USED</span>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between items-center text-[9px] font-mono font-bold uppercase">
                    <span className="text-muted-foreground">CPU CLUSTERS OVERLOAD RATE</span>
                    <span className={`font-mono font-bold ${sums.maxQueue > 5000 ? 'text-yellow-600 dark:text-yellow-400' : 'text-muted-foreground'}`}>
                      {sums.maxQueue > 5000 ? '42% (WARN)' : '14% (IDEAL)'}
                    </span>
                  </div>
                  <div className="w-full h-1 bg-muted rounded-full overflow-hidden">
                    <div 
                      className={`h-full rounded-full transition-all duration-1000 ${sums.maxQueue > 5000 ? 'bg-yellow-500' : 'bg-emerald-505 dark:bg-emerald-500'}`} 
                      style={{ width: sums.maxQueue > 5005 || sums.maxQueue > 5000 ? '42%' : '14%' }} 
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="border-t border-border pt-3">
              <span className="text-[8px] font-mono text-muted-foreground uppercase block leading-relaxed">
        ...
        <div className="xl:col-span-2 bg-card border border-border rounded-xl p-5 flex flex-col justify-between shadow-lg h-103.75px relative overflow-hidden group">
          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-4">
            ...
            {sums.maxQueue > 5000 && (
              <div className="flex items-center gap-1.5 text-[8px] font-mono font-black uppercase text-amber-500 bg-amber-500/15 border border-amber-500/30 px-2.5 py-1 rounded shadow-sm animate-pulse shrink-0">
                ...
                >
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={activePipelineData} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                      ...
                      <XAxis dataKey="hour" stroke="#94a3b8" tickLine={false} />
